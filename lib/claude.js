...
const TOOLS = [
  {
    name: "create_budget",
    description:
      "Crea un presupuesto orientativo formal en el chat. Solo se usa cuando el cliente está cualificado (zona dentro de cobertura, alcance claro y muestra intención de avanzar) y ya ha facilitado email. El sistema enviará un enlace de confirmación al email antes de mostrar el presupuesto.",
    input_schema: {
      type: "object",
      properties: {
        title: {
...
async function runConversation({ systemPrompt, messages, onBudget, onNotifyHuman }) {
